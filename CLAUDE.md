...
frontend/src/
  ...
  hooks/             useApi.js (useAuth, useApi),
                     ...
                     useDropToasts.js
  components/
    (root)           Card, Loader, ErrorAlert, EmptyState, StatusBadge,
