...
describe('Dashboard', () => {
  ...
  it('tapping a habit on Today posts to /habits/{id}/log/ and refetches', async () => {
  ...
  it('completing a chore on Today posts to /chores/{id}/complete/ and refetches', async () => {
    const user = userEvent.setup();
    ...
    const button = await screen.findByRole('button', { name: /complete dishes/i });
    await user.click(button);
