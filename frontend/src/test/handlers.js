...
export const handlers = [
  ...
  http.get('*/api/auth/join/*', () => HttpResponse.json({ family_name: 'Test', invited_by: 'P', expires_at: '' })),
  http.post('*/api/auth/join/*', ok),
  http.post('*/api/family/invites/', () => HttpResponse.json({ token: 't', join_path: '/join/t', expires_at: '' })),
