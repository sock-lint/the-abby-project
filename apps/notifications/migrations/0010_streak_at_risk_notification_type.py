# Sync notification choices with the model. Adds ``streak_at_risk`` —
# the preventative evening warning fired by
# ``apps.rpg.tasks.streak_at_risk_warning_task`` before a streak breaks.
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("notifications", "0009_add_reward_restocked_and_expedition_types"),
    ]
