# Sync notification choices with the model. Adds two values that landed
# on the model since 0008: ``reward_restocked`` (wishlist re-stock fanout)
# and ``expedition_returned`` (mount-expedition claim).
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("notifications", "0008_pet_quest_drop_stock_notification_types"),
    ]
